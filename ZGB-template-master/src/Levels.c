...
const unsigned char level4Map[] = {
   ...
   16, 10,  3,  7,  0, 16, 16, 16, 16, 16,  0,  6,  3,  9, 16, // "CHHH CCCCC HHHC",
//     0, 17, 17,  0, 12,  0, 16,  0, 16,  0, 12, 16, 16, 16, 16, // "C  V  CCC  V  C",
//    16, 16, 16, 16, 12,  0, 16,  0, 16,  0, 12, 16, 16, 16, 16, // "   HHH C HHH   ",
//    16, 16, 16, 16, 10,  3,  3,  7,  3,  3,  9,  0, 16, 16,  0, // "  B  V B V  B  ",
// 	0, 16, 16,  0,  0, 16,  0, 12,  0, 16,  0,  0, 16, 16,  0, // "  C  VCCCV  C  ",
//     0, 16, 16,  0,  0, 16,  0, 12,  0, 16,  0,  0,  0,  0,  0, // " CCC HHHHH CCC ",
//    16,  0,  0,  0,  0, 16,  0, 12,  0, 16,  0,  0,  0,  0, 16, // "CCCCC CVC CCCCC",
//    16, 16,  0,  0,  0, 16,  0, 11,  0, 16,  0,  0,  0, 16, 16, // "CCCCC CHC CCCCC"
};
